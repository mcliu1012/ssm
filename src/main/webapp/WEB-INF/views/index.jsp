...
<!--        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" /> -->
        ...
        <style>
            .closeitem{float:left;height:18px;line-height:8px;position:absolute;right:0;top:-1px;width:18px;z-index:99;cursor:pointer;}
        </style>
                ...
                <ul class="nav nav-list" id="menu">
                    ...
                    <li class="">
                        <a href="#" class="dropdown-toggle">
                            ...
                            <span class="menu-text"> 第一级菜单 </span>
                        ...
                        <ul class="submenu">
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child.shtml">
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child2.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---2
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child3.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---3
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child4.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---4
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child5.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---5
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child6.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---6
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child7.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---7
                                </a>
                    ...
                    <li class="">
                        <a href="#" class="dropdown-toggle">
                            ...
                            <span class="menu-text"> 第一级菜单222 </span>
                        ...
                        <ul class="submenu">
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child8.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---8
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child9.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---9
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child10.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---10
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child11.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---11
                                </a>
                            ...
                            <li class="">
                                <a target="mainFrame" href="javascript:;" url="pages/child12.shtml">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Child---12
                                </a>
